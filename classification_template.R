# Classifcation Template

## This is just a template, no example data set is modelled
...
## Step 2 - Fitting a classifier to the Training set
### Section where you create the clssifier here!
